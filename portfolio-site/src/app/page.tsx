    ...
    <main className="min-h-screen bg-neutral-950 text-white">
      <section className="mx-auto flex min-h-screen max-w-5xl items-center px-6 py-24">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg text-neutral-300">
            I focus on practical analytics systems that help teams move from raw
            data to better business decisions.
          </p>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-2xl text-neutral-400">
            Instead of stopping at reporting, this workflow turns sales,
            product, and promo signals into practical replenishment guidance.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-24">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            <h2 className="text-2xl font-semibold">What’s inside this system</h2>
            <p className="mt-4 max-w-2xl text-neutral-400">
              A simple view of the core pieces behind the workflow.
            </p>
          </div>
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-neutral-800 p-6">
            ...
            <p className="mt-3 text-sm text-neutral-400">
              Clean and structured sales, product, and promo data prepared for
              modeling.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-neutral-800 p-6">
            ...
            <p className="mt-3 text-sm text-neutral-400">
              Forward-looking signals that capture patterns, seasonality, and
              promotions.
            </p>
          </div>
          ...
          <div className="rounded-xl border border-neutral-800 p-6">
            ...
            <p className="mt-3 text-sm text-neutral-400">
              Practical guidance to support replenishment and inventory
              decisions.
            </p>
          </div>
        </div>
